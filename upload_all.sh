...
knife data bag from file dev  vine_web.json  --secret-file /Volumes/secret_keys/data_bags/dev_key
knife data bag from file dev  vine_xmpp.json --secret-file /Volumes/secret_keys/data_bags/dev_key
